public class DictTest {
    ...
    private static void testSortedArrayDictionary() {
        IDictionary<String, String> dict = new SortedArrayDictionary<>();
        testDict(dict);
    }

    private static void testHashDictionary() {
        IDictionary<String, String> dict = new HashDictionary<>(3);
        testDict(dict);
    }

    private static void testBinaryTreeDictionary() {
        IDictionary<String, String> dict = new BinaryTreeDictionary<>();
        testDict(dict);
        ...
        for (IDictionary.Entry<Integer, Integer> e : btd) {
    ...
    private static void testDict(IDictionary<String, String> dict) {
        ...
        for (IDictionary.Entry<String, String> e : dict) {
